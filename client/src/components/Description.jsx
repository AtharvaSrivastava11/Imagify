      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row item-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>
                ...
                Weather you need stunning visuals or unique imagery, our tool transform
            ...
            <p className='text-gray-600'>
                ...
                high-quality images in seconds. From products visuals to character design and portraits,
